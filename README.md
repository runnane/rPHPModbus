...
About
-----------
rPHPModbus is a set of PHP classes to communicate with modbus bus nodes. For now, function codes 1, 2, 3 and 5 are implemented.
...
* Implementing Modbus function codes 4, 6, 15, 16
